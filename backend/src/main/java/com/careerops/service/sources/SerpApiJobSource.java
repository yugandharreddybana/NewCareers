 ...
 *   - Sponsorship detected via title/description keyword heuristic
 */
@Component
public class SerpApiJobSource implements JobSource {
    ...
    public List<Job> search(SearchParams params, UserProfile profile) {
        ...
        String location = (params.getLocation() != null && !params.getLocation().isBlank()
        ...
        try {
            ...
            log.info("SerpAPI returned {} jobs for '{}'", results.size(), query);
        } catch (Exception e) {
