...
ALTER TABLE user_jobs ADD COLUMN IF NOT EXISTS matched_skills TEXT[];
ALTER TABLE user_jobs ADD COLUMN IF NOT EXISTS unmatched_skills TEXT[];
ALTER TABLE user_jobs ADD COLUMN IF NOT EXISTS cv_improvement_tips TEXT[];
