...
-- V60 — Add performance-enhancing GIN indexes for JSONB and TEXT[] columns across high-traffic tables.
...
-- 2. GIN indexes on user_jobs TEXT[] columns
...
-- 3. GIN indexes on user_profiles TEXT[] columns
